...
Spotlight Search – Find Anything, Anywhere connects to external services operated by Pixar Labs and affiliated websites to provide certain features, improve the plugin experience, and retrieve promotional content, news feeds, documentation links, and related resources during normal plugin usage.

The plugin may communicate with:
https://pixarlabs.com
https://jeweltheme.com

No data is collected without user interaction or plugin usage.
The service only starts gathering basic telemetry data when a user allows it via the admin notice. We collect the data to ensure a seamless user experience for all our users.

Privacy Policy:
https://pixarlabs.com/privacy-policy
https://jeweltheme.com/privacy-policy

Terms & Conditions:
https://pixarlabs.com/terms-of-use
https://jeweltheme.com/terms-of-use
