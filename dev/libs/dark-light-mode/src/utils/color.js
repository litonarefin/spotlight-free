...
export function parseColorWithCache($color) {
    $color = $color.trim();
...
export function parseToHSLWithCache(color) {
...
// https://en.wikipedia.org/wiki/HSL_and_HSV
export function rgbToHSL({ r: r255, g: g255, b: b255, a = 1 }) {
    const r = r255 / 255;
    const g = g255 / 255;
    const b = b255 / 255;
...
export function lowerCalcExpression(color) {
...
export function getSRGBLightness(r, g, b) {
